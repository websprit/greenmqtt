...
async fn mqtt_v5_invalid_auth_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-auth-reason")).into(),
        ))
        .await
        .unwrap();
...
async fn mqtt_v5_invalid_auth_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-auth-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_second_connect_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-connect")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_malformed_remaining_length_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-bad-remaining-length")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pingreq_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-bad-pingreq-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_disconnect_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-bad-disconnect-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_unexpected_pubrec_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-unexpected-pubrec")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_unexpected_pubrel_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-unexpected-pubrel")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_unexpected_pubcomp_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-unexpected-pubcomp")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_auth_method_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-auth-method")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_auth_data_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-auth-data")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_auth_reason_string_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-auth-reason-string")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_auth_data_without_method_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-auth-data-without-method")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_auth_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-auth-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_subscription_identifier_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-subscription-id")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_subscription_identifier_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-subscription-id")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_shared_subscription_with_no_local_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-shared-no-local")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_payload_format_indicator_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-payload-format-indicator")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_payload_format_indicator_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-payload-format-indicator")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_content_type_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-content-type")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_message_expiry_interval_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-message-expiry-interval")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_response_topic_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-response-topic")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_correlation_data_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-correlation-data")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_disconnect_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-disconnect-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_disconnect_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-disconnect-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_disconnect_reason_string_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-disconnect-reason-string")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrel_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrel-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrel_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrel-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_pubrel_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-pubrel-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_puback_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-puback-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrec_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrec-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubcomp_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubcomp-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_puback_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-puback-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_puback_properties_without_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-puback-properties-without-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrec_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrec-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_pubrec_properties_without_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-pubrec-properties-without-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrec_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrec-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_pubrec_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-pubrec-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubrel_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubrel-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_pubrel_properties_without_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-pubrel-properties-without-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubcomp_reason_code_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubcomp-reason-code")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_puback_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-puback-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_puback_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-puback-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_pubcomp_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-pubcomp-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_pubcomp_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-pubcomp-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_disconnect_session_expiry_interval_disconnects_protocol_error_over_wss()
{
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-disconnect-session-expiry")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_subscribe_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-subscribe-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_subscribe_topic_filter_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-subscribe-topic-filter")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_empty_subscribe_payload_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-empty-subscribe-payload")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_empty_unsubscribe_payload_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-empty-unsubscribe-payload")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_subscribe_reserved_bits_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-subscribe-reserved-bits")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_unsubscribe_flags_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-unsubscribe-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_unsubscribe_property_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-unsubscribe-property")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_unsubscribe_topic_filter_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-unsubscribe-topic-filter")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_topic_alias_zero_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-alias-zero")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_unknown_topic_alias_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-alias-unknown")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_wss_connect_subscribe_publish_flow() {
    ...
    publisher
        .send(Message::Binary(
            (publish_packet("devices/d1/state", b"wss-up")).into(),
        ))
        .await
        .unwrap();
...
async fn mqtt_v5_invalid_retain_handling_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-retain-handling")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_subscription_qos_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-subscription-qos")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_publish_qos_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-publish-qos")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_invalid_publish_dup_qos0_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-invalid-publish-flags")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_duplicate_publish_topic_alias_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-duplicate-publish-topic-alias")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
...
async fn mqtt_v5_publish_subscription_identifier_disconnects_protocol_error_over_wss() {
    ...
    client
        .send(Message::Binary(
            (connect_packet_v5("wss-publish-subscription-identifier")).into(),
        ))
        .await
        .unwrap();
    let connack = client.next().await.unwrap().unwrap().into_data();
